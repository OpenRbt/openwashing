...
setup = function()
    ...
    init_prices()
    printMessage("Prices: " .. price_p[0] .. " " .. price_p[1] .. " " .. price_p[2] .. " " .. price_p[3])
...
left_show_choose = function()
    ...
    main_screen:Set("programs_left.position", "30;200")
    main_screen:Set("payment_method_left.position", "30;400")
    if fundraiser_active_right == false and hascardreader() then
        main_screen:Set("button_cash_left.position", "30;500")
    end
    main_screen:Set("button_cashless_left.position", "30;600")
    main_screen:Display()
end
...
left_show_fundraising = function(balance_rur)
    ...
    main_screen:Set("balance_left.position", "30;100")
    main_screen:Set("fundraising_left.position", "30;400")
    if balance_left >= min_cash_balance then
        main_screen:Set("button_begin_left.position", "30;700")
    end
    main_screen:Set("button_cancel_left.position", "30;800")
...
left_show_keyboard = function(balance_rur)
    ...
    main_screen:Set("balance_left.position", "30;100")
    main_screen:Set("enter_amount_left.position", "30;200")

    main_screen:Set("button_1_left.position", "30;300")
    main_screen:Set("button_2_left.position", "90;300")
    main_screen:Set("button_3_left.position", "150;300")
    main_screen:Set("button_4_left.position", "30;360")
    main_screen:Set("button_5_left.position", "90;360")
    main_screen:Set("button_6_left.position", "150;360")
    main_screen:Set("button_7_left.position", "30;420")
    main_screen:Set("button_8_left.position", "90;420")
    main_screen:Set("button_9_left.position", "150;420")
    main_screen:Set("button_0_left.position", "90;480")
...
left_show_wait = function(balance_rur)
    ...
    main_screen:Set("balance_left.position", "50;50")
    main_screen:Set("wait_left.position", "30;200")
    main_screen:Set("button_cancel_left.position", "30;800")
...
left_show_work = function(balance_rur)
    ...
    main_screen:Set("balance_left.position", "50;50")
    main_screen:Set("console_left.position", "30;200")
    main_screen:Set("button_pause_left.position", "30;800")
...
left_show_thanks = function()
    ...
    left_charge_balance(0)
    main_screen:Set("balance_left.position", "50;50")
    main_screen:Set("thanks_left.position", "30;200")
    main_screen:Display()
end
...
left_show_apology = function()
    ...
    left_charge_balance(0)
    main_screen:Set("balance_left.position", "50;50")
    main_screen:Set("apology_left.position", "30;200")
    main_screen:Display()
end
...
right_show_choose = function()
    ...
    main_screen:Set("programs_right.position", "300;200")
    main_screen:Set("payment_method_right.position", "300;400")
    if fundraiser_active_left == false and hascardreader() then
        main_screen:Set("button_cash_right.position", "300;500")
    end
    main_screen:Set("button_cashless_right.position", "300;600")
    main_screen:Display()
end
...
right_show_fundraising = function(balance_rur)
    right_disable_visibility()
    main_screen:Set("balance_right.position", "300;100")
    main_screen:Set("fundraising_right.position", "300;400")
    if balance_right >= min_cash_balance then
    main_screen:Set("button_begin_right.position", "300;700")
    end
    main_screen:Set("button_cancel_right.position", "300;800")
...
right_show_keyboard = function(balance_rur)
    ...
    main_screen:Set("balance_right.position", "300;100")
    main_screen:Set("enter_amount_right.position", "300;200")

    main_screen:Set("button_1_right.position", "300;300")
    main_screen:Set("button_2_right.position", "360;300")
    main_screen:Set("button_3_right.position", "420;300")
    main_screen:Set("button_4_right.position", "300;360")
    main_screen:Set("button_5_right.position", "360;360")
    main_screen:Set("button_6_right.position", "420;360")
    main_screen:Set("button_7_right.position", "300;420")
    main_screen:Set("button_8_right.position", "360;420")
    main_screen:Set("button_9_right.position", "420;420")
    main_screen:Set("button_0_right.position", "360;480")
...
right_show_wait = function(balance_rur)
    ...
    main_screen:Set("balance_right.position", "50;50")
    main_screen:Set("wait_right.position", "300;200")
    main_screen:Set("button_cancel_right.position", "300;800")
...
right_show_work = function(balance_rur)
    ...
    main_screen:Set("balance_right.position", "50;50")
    main_screen:Set("console_right.position", "300;200")
    main_screen:Set("button_pause_right.position", "300;800")
...
right_show_thanks = function()
    ...
    right_charge_balance(0)
    main_screen:Set("balance_right.position", "50;50")
    main_screen:Set("thanks_right.position", "300;200")
    main_screen:Display()
end
...
right_show_apology = function()
    ...
    right_charge_balance(0)
    main_screen:Set("balance_right.position", "50;50")
    main_screen:Set("apology_right.position", "300;200")
    main_screen:Display()
end
