...
int DiaRuntime::InitStr(std::string folder, std::string src_str, std::string incl_str) {
    ...
    *LoopFunction = loopFunction;
    ...
    .addFunction("BonusSystemGetClient", &DiaRuntimeHardware::BonusSystemGetClient)
    .addFunction("BonusSystemGetBalance", &DiaRuntimeHardware::BonusSystemGetBalance)
    .addFunction("BonusSystemSetBalance", &DiaRuntimeHardware::BonusSystemSetBalance)
